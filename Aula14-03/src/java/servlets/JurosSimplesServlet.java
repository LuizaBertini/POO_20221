...
public class JurosSimplesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServletJurosSimples</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try {
                ...
                int valor_atual = Integer.parseInt(request.getParameter("valor_p_js"));
                int juros = Integer.parseInt(request.getParameter("juros_s"));
                int meses = Integer.parseInt(request.getParameter("meses_js"));
                double new_juros = juros/100;
                double resultado = (valor_atual * (1 + new_juros * meses));
